...
<link rel="stylesheet" href="Profil.css" media="screen">
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="Moje-zlecenia.php" style="padding: 10px 20px;">Moje zlecenia</a>
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="Moje-zlecenia.php" style="padding: 10px 20px;">Moje zlecenia</a>
  ...
  <section class="u-align-center u-black u-clearfix u-container-style u-dialog-block u-opacity u-opacity-70 u-valign-middle u-section-4" id="sec-66ea">
      <div class="u-align-center u-container-style u-dialog u-opacity u-opacity-90 u-radius-10 u-shape-round u-white u-dialog-1">
        <div class="u-container-layout u-valign-middle u-container-layout-1">
          ...
          <div class="u-align-left u-expanded-width-xs u-form u-form-1">
            <form action="scripts/form-66ea-3.php" method="POST" class="u-clearfix u-form-spacing-28 u-form-vertical u-inner-form" style="padding: 0px;" source="customphp" name="form">
              <div class="u-form-email u-form-group u-form-group-1">
                ...
                <input type="email" id="email-a136" name="email" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="" placeholder="Wpisz email">
              </div>
              <div class="u-form-group u-form-group-2">
                <label for="text-14f4" class="u-label u-text-grey-30 u-label-2">Imię</label>
                <input type="text" placeholder="Wpisz imię " id="text-14f4" name="text" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
              </div>
              <div class="u-form-group u-form-group-3">
                <label for="text-cab4" class="u-label u-text-grey-30 u-label-3">Nazwisko</label>
                <input type="text" placeholder="Nazwisko" id="text-cab4" name="text-1" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
              </div>
